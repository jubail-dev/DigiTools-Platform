...
const Available = ({ product }: AvailableProps) => {
  ...
  return (
    <div className="relative flex flex-col justify-between max-w-sm rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-md">
      ...
      {/* Button */}
      <div className="mt-6">
        <button className="w-full rounded-xl bg-blue-600 py-2.5 px-4 text-center text-sm font-semibold text-white transition hover:bg-blue-700">
          Buy Now
        </button>
      </div>
    </div>
